...
class get_config():
    def __init__(self):
        ...
        self.parser.add_argument('--shuffle', default=int, help='shuffle when training')
        ...
        self.parser.add_argument('--thd', type=float, default=0.5, help='threshold for ber compute')
        ...
        if self.phase == 'train':
            ...
            if self.resume == True:
                ...
                self.resume_ckp_dir = 'result/'+self.suffix+'/ckp/'+self.resume_epoch
