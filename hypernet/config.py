...
class get_config():
    def __init__(self):
        ...
        # Training Parameters
        self.parser.add_argument('--epoch', type=int, default=460, help='# of fine_epoch ')
        ...
        self.parser.add_argument('--doppler', type=int, default=165, help='doppler value')
        ...
        if self.phase == 'train':
            ...
            resume_info = 'MIMO'
            self.test_ckp_dir = 'result/' + resume_info + '/ckp/epoch479'
